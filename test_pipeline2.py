...
def test_pipeline():
    ...
    win._conversion_mgr.file_finished.connect(lambda r: print(f"FINISHED: {r.input_file}, success={r.success}, md_len={len(r.markdown) if r.markdown else 'None'} error={r.error_message}"))
